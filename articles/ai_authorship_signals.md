...
人間がカジュアルな文章で「✅これは良い、❌これはダメ」と書くことってあまりないと思います。プレゼン資料やマニュアルなら 100 歩譲ってわからなくはないですけど、ブログ記事や日常的な説明でこの書き方をする人は少数派じゃないでしょうか。
...
#### 2.1. なぜこうなってしまうのか
LLMは情報の欠落を極端に嫌います。学習の過程で「網羅的に答える」ことが良いとされてきたからです。
人間は会話の中で「これは省略しても伝わるな」「これは聞かれてないから言わなくていいな」と自然に判断しています。相手の知識レベル、関心、文脈を読み取って、情報をフィルタリングしているんですね。
LLMはこのフィルタリングが苦手です。「言わないよりは言っておいた方が安全」というスタンスなので、結果として冗長になります。読み手からすると、「この人、本題に自信がないから補足で埋めてるのかな」という印象になりかねないです。
...
「さまざまな場面で活用できます」
「人によって異なりますが〜」
AI文章にはこういう「誰にでも当てはまる」言い方が多いです。具体的なようで、実は何も言っていない表現。
...
もしこの記事を読んでいて「なんか読みにくいな」「AIっぽいな」と感じた部分があったとしたら、それは Claude のせいです。逆に「ここは読みやすかった」という部分があれば、それは私の編集力です。たぶん。